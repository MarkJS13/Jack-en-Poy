...
let computerAnswer = (random) => {
   ...
   let computer = '';
   if(random == 0) {
      result.innerHTML = '<p> Computer selects rock </p> <img src="images/rock.png">';
      computer += 'rock';
    } else if(random == 1) {
      result.innerHTML = ' <p> Computer selects paper </p> <img src="images/paper.png">';
      computer += 'paper';
    } else if(random == 2) {
      result.innerHTML = '<p> Computer selects scissor </p> <img src="images/scissors.png">';
      computer += 'scissors';
    }
    return computer;
}
...
reset.addEventListener('click', e => {
   ...
   computer.textContent = `Computer: ${computerScore}`;
   result.textContent = '';
   placeholder.textContent = "JACK EN' POY";
})
